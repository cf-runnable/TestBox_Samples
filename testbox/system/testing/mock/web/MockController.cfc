...
----------------------------------------------------------------------->
<cfcomponent hint="This is the ColdBox Unit Test Front Controller." output="false" extends="testbox.system.web.Controller">

<!------------------------------------------- PUBLIC ------------------------------------------->

	<cffunction name="init" returntype="testbox.system.web.Controller" access="public" hint="Constructor" output="false">
		...
		<cfscript>
			...
			// Override mocks
			setRequestService( CreateObject("component","testbox.system.testing.mock.services.MockRequestService").init(this) );
