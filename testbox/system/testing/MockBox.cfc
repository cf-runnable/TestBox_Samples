...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<!--- Get Generator --->
	<cffunction name="getMockGenerator" access="public" returntype="testbox.system.testing.mockutils.MockGenerator" output="false" hint="Get the Mock Generator Utility">
	...
	<cffunction name="createStub" output="false" access="public" returntype="any" hint="Create an empty stub object that you can use for mocking.">
		...
		<cfscript>
			...
			if( NOT len( trim( arguments.implements ) ) AND NOT len( trim( arguments.extends ) ) ){
				return createMock(className="testbox.system.testing.mockutils.Stub", callLogging=arguments.callLogging);
			}
...
<!------------------------------------------- PRIVATE ------------------------------------------>
	...
	<!--- Get ColdBox Util --->
	<cffunction name="getUtil" access="private" output="false" returntype="testbox.system.core.util.Util" hint="Create and return a util object">
		<cfreturn createObject("component","testbox.system.core.util.Util")/>
	</cffunction>
