...
---------------------------------------------------------------------->
<cfcomponent output="false" extends="testbox.system.testing.BaseTestCase" hint="A base test for unit testing event handlers">
    ...
    <cffunction name="setup" output="false" access="public" returntype="void" hint="Prepare for testing">
    	<cfscript>
			...
			// Create Mock Objects
			variables.mockController 	 = mockBox.createEmptyMock("testbox.system.testing.mock.web.MockController");
			variables.mockRequestContext = getMockRequestContext();
			variables.mockRequestService = mockBox.createEmptyMock("testbox.system.web.services.RequestService").$("getContext", variables.mockRequestContext);
			...
			variables.mockFlash		 	 = mockBox.createMock("testbox.system.web.flash.MockFlash").init(mockController);
			variables.mockCacheBox   	 = mockBox.createEmptyMock("testbox.system.cache.CacheFactory");
			variables.mockWireBox		 = mockBox.createEmptyMock("testbox.system.ioc.Injector");
